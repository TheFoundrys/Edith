  ...
  const [info] = useState<string | null>(
    resetParam === "success"
      ...
      : searchParams.get("invite") === "accepted"
        ? "Invitation accepted. Sign in to open your workspace."
        : noticeParam === "membership_suspended"
          ? "This account is suspended. Contact an administrator."
          : noticeParam === "membership_expired"
            ? "This membership has expired. Contact an administrator."
            : null,
  );
