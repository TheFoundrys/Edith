...
export default async function AdminTransactionsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Transactions"
        description="All course-fee and application-fee transactions."
        actions={
          isSuperAdmin(session.user.role) && !isCompassDatabase() ? (
      ...
      {payments.length === 0 ? (
        <EmptyState
          ...
          description="Records appear here when students pay course or application fees."
        />
      ) : (
