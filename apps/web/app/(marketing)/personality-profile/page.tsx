...
export default async function PersonalityProfilePublicPage() {
  ...
  const enrollCallback = encodeURIComponent(PERSONALITY_PROFILE_ENROLL_HREF);
  ...
  if (enrollmentState.kind === "active") {
